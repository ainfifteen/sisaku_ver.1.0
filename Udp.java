...
public class Udp {
	...
	// sendMsgsメソッド
	// マルチキャストパケットの送信を担当
	public void sendMsgs(int dport, int people, double x, double y, double battery, int port)
	{
		try{
	...
	public void sendMsgFromServer(int port, String judg)//エッジサーバからの送信 引数はのちのち追加予定
	{
		try{
